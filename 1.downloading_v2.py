...
# Specify the path to your JSON file and the string you want to search for
json_file_path = 'sfx_1_2_3_4_5_6.json_136584_elements copy.json'
json_file_path = os.path.join("merged_jsons", json_file_path)
total_count = 0
